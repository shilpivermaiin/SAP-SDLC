...
| 1.1 | 2026-09-17 | ankur.gupta04@nagarro.com | Removed the formal approval step for module-level estimates (decided during `/FunctionalSpec`); Practice/Delivery Leads now contribute estimates that are visible for review on dashboards, without a blocking approval gate. No `/Code` or `/Testing` artifacts existed yet for this requirement, so there is no rebuild/re-test/back-out impact. | Approved |
...
- Practice/delivery leads contribute the effort and cost estimate for their respective module(s); estimates are visible on dashboards for review, without a formal approval gate.
...
- Practice/delivery lead contribution of module-level effort and cost estimates (visible for review; no formal approval gate)
...
| Practice / Delivery Lead | Provides module-level effort and cost estimates (visible for review; no formal approval gate) |
